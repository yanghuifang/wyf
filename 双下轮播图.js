...
function banner(imgs,dot,banner,leftbtn,rightbtn,width)
{ 	 	
		 	imgs[0].style.left="30px";
		 	dot[0].className="active1";
		  let flag=true;
		 	let now=0;
		 	let next=0;
//		 let t=setInterval(move,2000);
		 function move()
		 {
			...
			dot[now].classList.remove("active1");
			dot[next].classList.add("active1");
			now=next;
		}
		function moveL()
		{
